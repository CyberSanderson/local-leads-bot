...
import { caseStudies } from '@/data/caseStudies'; // We import the data from our new file
...
// The old 'const caseStudies' array is now deleted from this file.
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {caseStudies.map((study) => (
              <Link
                // I've updated this to use 'study.slug' to match our new data file

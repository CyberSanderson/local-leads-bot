...
const FeatureItem = ({ icon, title, children }: { icon: React.ReactNode; title: string; children: React.ReactNode }) => ( /* ... component code ... */ );

export default function Home() {
  const softwareApplicationSchema = { /* ... schema data ... */ };

    ...
    <>
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <FeatureItem icon={<MessageSquare className="w-6 h-6" />} title="Easy to Install">
            You&apos;ll be up and running in minutes. No coding required.
          </FeatureItem>
          <FeatureItem icon={<Zap className="w-6 h-6" />} title="Automated Leads">
            Capture new leads 24/7 automatically and grow your business.
          </FeatureItem>
          <FeatureItem icon={<Code className="w-6 h-6" />} title="Customizable">
            Customize your chatbot&apos;s appearance and questions to fit your brand.
          </FeatureItem>
        </div>
      </section>

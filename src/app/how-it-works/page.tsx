        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-semibold text-lg flex items-center"><HelpCircle className="w-5 h-5 mr-2 text-blue-600"/>Does this work on my website?</h3>
              <p className="mt-2 text-gray-700">{"Yes. As long as you can edit your website's HTML to paste in one line of code, our chatbot will work. This includes virtually all website builders like WordPress, Wix, Squarespace, etc."}</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-semibold text-lg flex items-center"><HelpCircle className="w-5 h-5 mr-2 text-blue-600"/>Do I need to know how to code?</h3>
              <p className="mt-2 text-gray-700">{"Not at all! Customizing and installing the bot is a simple copy-and-paste process. All the settings are managed in our easy-to-use dashboard."}</p>
            </div>
          </div>
        </div>
      </section>
